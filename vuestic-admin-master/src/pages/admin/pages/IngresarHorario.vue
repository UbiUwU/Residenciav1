      ...
      <va-card-content>
        <div class="mb-6">
          <va-alert color="info" class="mb-4">
            Selecciona las horas en las que estarás disponible durante el semestre. Este horario se aplicará a todas las semanas.
          </va-alert>
          
          <va-checkbox
            v-model="todasLasHoras"
            label="Seleccionar todas las horas de los días marcados"
            class="mb-4"
          />
        </div>
        ...
        <div class="flex justify-end gap-4 mt-6">
          <va-button @click="limpiarSeleccion" color="danger">
            Limpiar selección
          </va-button>
          <va-button @click="guardarHorario" :disabled="horarioSeleccionado.length === 0">
            Guardar horario
          </va-button>
        </div>
      </va-card-content>
