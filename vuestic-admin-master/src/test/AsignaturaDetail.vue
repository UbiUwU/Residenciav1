<template>
      ...
      <div v-else>
        <div class="header-info">
          ...
          <div class="meta-info">
            ...
            <span>SATCA: Total {{ asignatura.Satca_Total }} (Teóricas: {{ asignatura.Satca_Teoricas }}, Prácticas: {{ asignatura.Satca_Practicas }})</span>
          </div>
        </div>
  ...
  .subtemas ul, .actividades ul {
    padding-left: 20px;
  }
  
  .subtemas li, .actividades li {
    margin-bottom: 5px;
  }
