<template>
    <div class="p-4">
        ...
        <button class="mb-4 bg-blue-600 text-white px-4 py-2 rounded" @click="abrirFormulario()">
            Nuevo Maestro
        </button>
            ...
            <tbody>
                <tr v-for="maestro in maestros" :key="maestro.tarjeta">
                    ...
                    <td class="border px-4 py-2">
                        ...
                        <button @click="eliminar(maestro.tarjeta)"
        ...
        <div v-if="mostrarFormulario" class="mt-6 bg-gray-100 p-4 rounded">
            ...
            <form @submit.prevent="guardarMaestro">
                ...
                <div class="mb-4 p-4 bg-white rounded">
                    ...
                    <div class="mb-2">
                        <label>Tarjeta</label>
                        <input v-model="form.tarjeta" :disabled="editando" type="number" 
