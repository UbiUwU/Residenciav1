...
class LiberacionDocente extends Model
{
    protected $table = 'liberacion_docente';
    ...
    /**
     * Relación con los detalles de liberación
     */
    public function detalles(): HasMany
    {
        return $this->hasMany(LiberacionDocenteDetalle::class, 'id_liberacion', 'id_liberacion');
    }
