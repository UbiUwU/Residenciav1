...
use App\Models\LiberacionAcademicaDetalle;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\DB;
use Illuminate\Support\Facades\Validator;

class LiberacionAcademicaDetalleController extends Controller
{
    /**
    ...
    public function store(Request $request, $id_liberacion)
    {
        ...
        try {
            ...
            LiberacionAcademica::findOrFail($id_liberacion);
            ...
            $existe = LiberacionAcademicaDetalle::where('id_liberacion', $id_liberacion)
            ...
            // Crear el detalle
            $detalle = new LiberacionAcademicaDetalle;
            ...
            return response()->json([
                'success' => true,
                'message' => 'Detalle de liberación académica creado exitosamente',
                'data' => $detalle,
            ], 201);
    ...
    public function update(Request $request, $id)
    {
        ...
        try {
            ...
            $detalle = LiberacionAcademicaDetalle::findOrFail($id);
    ...
    public function updateMultiple(Request $request, $id_liberacion)
    {
        ...
        try {
            $validator = Validator::make($request->all(), [
                'detalles' => 'required|array',
                'detalles.*.id_detalle' => 'required|exists:liberacion_academica_detalles,id_detalle',
            ...
            foreach ($request->detalles as $detalleData) {
                $detalle = LiberacionAcademicaDetalle::where('id_detalle', $detalleData['id_detalle'])
